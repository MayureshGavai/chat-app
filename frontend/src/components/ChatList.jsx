...
const ChatList = ({className}) => {
  ...
  return (
    <div className={`${className} border-r h-screen ${themeMode === 'dark' ? 'dark' : 'light'} `}>
        ...
        <div className='w-full px-4 py-3 shadow-sm flex justify-between items-center dark:border-b dark:border-gray-600'>
            <img src={themeMode === "light" ? ChatLogo : DarkChatLogo} alt="" className='w-8 h-8'/>
            <Menu as="div" className="relative inline-block text-left dark:bg-black-900 dark:text-white">
        ...
        <div className='my-3 px-4 flex justify-between items-center'>
            <input type="text" className='w-full mr-2 px-2 py-1 border rounded-md bg-transparent dark:text-white dark:border-gray-600' placeholder='Search'/>
            <AddModal />
       </div>
